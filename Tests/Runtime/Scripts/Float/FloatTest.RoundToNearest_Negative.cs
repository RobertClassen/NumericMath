namespace NumericMath
{
	...
	{
		[Test]
		public void RoundToNearest_NegativeValue_NegativeStepSize_Throws()
		{
		...
		[Test]
		public void RoundToNearest_NegativeValue_PositiveStepSize_Magnitude0_001()
		{
			const float value = -1234.5678f;
		...
		[Test]
		public void RoundToNearest_NegativeValue_PositiveStepSize_Magnitude0_01()
		{
			const float value = -1234.5678f;
		...
		[Test]
		public void RoundToNearest_NegativeValue_PositiveStepSize_Magnitude0_1()
		{
			const float value = -1234.5678f;
		...
		[Test]
		public void RoundToNearest_NegativeValue_PositiveStepSize_Magnitude1()
		{
			const float value = -1234.5678f;
		...
		[Test]
		public void RoundToNearest_NegativeValue_PositiveStepSize_Magnitude10()
		{
			const float value = -1234.5678f;
		...
		[Test]
		public void RoundToNearest_NegativeValue_PositiveStepSize_Magnitude100()
		{
			const float value = -1234.5678f;
		...
		[Test]
		public void RoundToNearest_NegativeValue_PositiveStepSize_Magnitude1000()
		{
			const float value = -1234.5678f;
