namespace NumericMath
{
	...
	public static partial class ByteExtensions
	{
		...
		/// </summary>
		public static byte RoundBetweenMinToMax(this byte value, double stepSize, double percent, 
			bool clamp = Numeric.IsLerpClampedDefault)
		{
			return (byte)((double)value).RoundBetweenMinToMax(stepSize, percent, clamp);
		}
	}
}