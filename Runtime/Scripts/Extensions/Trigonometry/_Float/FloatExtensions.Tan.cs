namespace NumericMath
{
	...
	public static partial class FloatExtensions
	{
		...
		public static float Atan(this float tan, bool toDegrees = Angle.IsDegreesDefault)
		{
			return (float)Math.Atan(tan).ToDegrees(toDegrees);
		}
		...
		public static float Tan(this float angle, bool fromDegrees = Angle.IsDegreesDefault)
		{
			return (float)Math.Tan(angle.ToRadians(fromDegrees));
		}
