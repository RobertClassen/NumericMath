namespace NumericMath
{
	...
	public static partial class FloatExtensions
	{
		...
		/// </summary>
		public static IEnumerable<float> Add(this float value, IList<float> addends, 
		...
		/// or the previous sum, respectively.
		/// </summary>
		public static IEnumerable<float> Add(this float value, IEnumerable<float> addends, 
			bool iterateOnPrevious = Numeric.IterateOnPreviousDefault)
		{
			if(iterateOnPrevious)
			{
