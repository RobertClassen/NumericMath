namespace NumericMath
{
	...
	public static partial class FloatExtensions
	{
		...
		public static IEnumerable<float> Repeat(this float value, int count)
		{
			if(count < Int.Zero)
			{
		...
		/// </param>
		public static IEnumerable<float> Repeat(this IList<float> values, int count, bool byIndex = Numeric.RepeatByIndexDefault)
		{
			if(count < Int.Zero)
			{
				throw new ArgumentLessThanZeroException(nameof(count), count);
