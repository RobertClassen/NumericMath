namespace NumericMath
{
	...
	public static partial class ByteExtensions
	{
		...
		/// </summary>
		public static IEnumerable<byte> Subtract(this byte value, IList<byte> subtrahends, 
		...
		/// or the previous difference, respectively.
		/// </summary>
		public static IEnumerable<byte> Subtract(this byte value, IEnumerable<byte> subtrahends, 
			bool iterateOnPrevious = Numeric.IterateOnPreviousDefault)
		{
			if(iterateOnPrevious)
			{
