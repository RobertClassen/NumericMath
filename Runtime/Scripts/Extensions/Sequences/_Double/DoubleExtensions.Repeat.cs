namespace NumericMath
{
	...
	public static partial class DoubleExtensions
	{
		...
		public static IEnumerable<double> Repeat(this double value, int count)
		{
			if(count < Int.Zero)
			{
		...
		/// </param>
		public static IEnumerable<double> Repeat(this IList<double> values, int count, bool byIndex = Numeric.RepeatByIndexDefault)
		{
			if(count < Int.Zero)
			{
				throw new ArgumentLessThanZeroException(nameof(count), count);
