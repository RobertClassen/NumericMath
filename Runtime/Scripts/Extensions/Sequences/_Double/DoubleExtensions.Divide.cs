namespace NumericMath
{
	...
	public static partial class doubleExtensions
	{
		...
		/// </summary>
		public static IEnumerable<double> Divide(this double value, IList<double> divisors, bool iterateOnPrevious = Numeric.IterateOnPreviousDefault)
		{
		...
		/// or the previous quotient, respectively.
		/// </summary>
		public static IEnumerable<double> Divide(this double value, IEnumerable<double> divisors, bool iterateOnPrevious = Numeric.IterateOnPreviousDefault)
		{
			if(iterateOnPrevious)
			{
