namespace NumericMath
{
	...
	public static partial class ShortExtensions
	{
		...
		public static IEnumerable<short> Repeat(this short value, int count)
		{
			if(count < Int.Zero)
			{
		...
		/// </param>
		public static IEnumerable<short> Repeat(this IList<short> values, int count, bool byIndex = Numeric.RepeatByIndexDefault)
		{
			if(count < Int.Zero)
			{
				throw new ArgumentLessThanZeroException(nameof(count), count);
