namespace NumericMath
{
	...
	public static partial class LongExtensions
	{
		...
		/// </summary>
		public static IEnumerable<long> Divide(this long value, IList<long> divisors, 
		...
		/// or the previous quotient, respectively.
		/// </summary>
		public static IEnumerable<long> Divide(this long value, IEnumerable<long> divisors, 
			bool iterateOnPrevious = Numeric.IterateOnPreviousDefault)
		{
			if(iterateOnPrevious)
			{
