namespace NumericMath
{
	...
	public static partial class longExtensions
	{
		...
		/// </summary>
		public static IEnumerable<long> Multiply(this long value, IList<long> multiplicands, bool iterateOnPrevious = Numeric.IterateOnPreviousDefault)
		{
		...
		/// or the previous product, respectively.
		/// </summary>
		public static IEnumerable<long> Multiply(this long value, IEnumerable<long> multiplicands, bool iterateOnPrevious = Numeric.IterateOnPreviousDefault)
		{
			if(iterateOnPrevious)
			{
