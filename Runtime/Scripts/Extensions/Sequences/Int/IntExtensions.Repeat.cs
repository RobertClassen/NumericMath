namespace NumericMath
{
	...
	public static partial class IntExtensions
	{
		...
		public static IEnumerable<int> Repeat(this int value, int count)
		{
			if(count < Int.Zero)
			{
		...
		/// </param>
		public static IEnumerable<int> Repeat(this IList<int> values, int count, bool byIndex = Numeric.RepeatByIndexDefault)
		{
			if(count < Int.Zero)
			{
				throw new ArgumentLessThanZeroException(nameof(count), count);
